export default {
  ...
  package: {
    ...
    copyTrackingId: "Kopjo tracking id",
    showQrCode: "Trego QR Code",
    courier: "Korrieri:",
    callCourier: "Telefono korrierin",
    sendPackageReference: "Dërgoji referencën e pakos",
    address: "Adresa:",
